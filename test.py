...
expected_json =    {"1": (TEXT_FORMAT, 18.88888888888889),
                    "2": (TEXT_FORMAT, 25.0),
                    "3": (TEXT_FORMAT, 2.0),
                    "4": (TEXT_FORMAT, 1.0),
                    "5": (TEXT_FORMAT, 12.380952380952381),
                    "6": (TEXT_FORMAT, 8.076923076923077),
                    "7": (TEXT_FORMAT, 34.666666666666664),
                    "8": (TEXT_FORMAT, 13),
                    "9": (TEXT_FORMAT, 17),
                    "10": (TEXT_FORMAT, 'Flareon'),
                    "11": (TEXT_FORMAT, 'Blastoise'),
                    "12": (TEXT_FORMAT, 'Starly'),
                    "13": (TEXT_FORMAT, 'Draw'),
                    "14": (TEXT_FORMAT, 'Pikachu ran away'),
                    "15": (TEXT_FORMAT, 'Lucario'),
                    "16": (TEXT_FORMAT, 'Mew ran away'),
                    "17": (TEXT_FORMAT, 2),
                    "18": (TEXT_FORMAT, 0),
                    "19": (TEXT_FORMAT, 5),
                    "20": (TEXT_FORMAT, 3)}
